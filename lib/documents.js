...
import { money, dollarsInWords, prettyDate, TERM_LABELS, dueAtSigning } from './format.js';
...
export function renderContract(r) {
  ...
  <p style="font-size:10pt;margin-top:10px;">Tenant Initials: ________ &nbsp;&nbsp;&nbsp; Provider Initials: ________</p>
  ` : ''}
